				...
				<div class="d-flex flex-column flex-center text-center p-10">
					...
					<div class="card card-flush w-lg-650px py-5">
						<div class="card-body py-15 py-lg-20">
							...
							<!--end::Title-->
							<!--begin::Text-->
							<div class="fw-semibold fs-6 text-gray-500 mb-7">الصفحة التي تبحث عنها غير موجودة!.</div>
							<!--end::Text-->
							<!--begin::Illustration-->
							<div class="mb-3">
								<img src="{{ asset('assets/media/auth/404-error.png') }}" class="mw-100 mh-300px theme-light-show" alt="ww" />
								<img src="{{ asset('assets/media/auth/404-error-dark.png') }}" class="mw-100 mh-300px theme-dark-show" alt="wwww" />
							</div>
							<!--end::Illustration-->
							<!--begin::Link-->
							<div class="mb-0">
