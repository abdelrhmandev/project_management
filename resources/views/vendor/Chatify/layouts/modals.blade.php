  ...
  <div class="app-modal" data-name="delete">
      <div class="app-modal-container">
          <div class="app-modal-card" data-name="delete" data-modal='0'>
              <div class="app-modal-header">{{ __('site.cancel') }}?</div>
              <div class="app-modal-body">{{ __('site.delete_confirm_chat')}}</div>
              <div class="app-modal-footer">
                  <a href="javascript:void(0)" class="app-btn cancel">{{ __('site.cancel') }}</a>
                  <a href="javascript:void(0)" class="app-btn a-btn-danger delete">{{ __('site.delete') }}</a>
              </div>
          </div>
      </div>
  </div>
          ...
          <div class="app-modal-card" data-name="settings" data-modal='0'>
              <form id="update-settings" action="{{ route('avatar.update') }}" enctype="multipart/form-data" method="POST">
                  ...
                  <div class="app-modal-body">
                      ...
                      {{-- Dark/Light Mode  --}}
                      <p class="divider"></p>
                      <p class="app-modal-header">{{ __('title_nav.dark') }} <span class="
                  ...
                  <div class="app-modal-footer">
                      <a href="javascript:void(0)" class="app-btn cancel">{{ __('site.cancel') }}</a>
                      <input type="submit" class="app-btn a-btn-success update" value="{{ __('site.save') }}" />
                  </div>
              </form>
          </div>
      </div>
