  ...
  <div class="container-fluid d-flex align-items-stretch justify-content-between">
    ...
    <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
      <a href="{{url('/')}}" class="d-lg-none">
        <img alt="Logo" src="{{ asset('assets/media/logos/pm-logo.svg') }}" class="h-30px">
      </a>
    </div>
    <!--end::Mobile logo-->
    <!--begin::Wrapper-->
    <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
      ...
      <div class="d-flex align-items-stretch flex-shrink-0">
        ...
        <div class="d-flex align-items-center ms-1 ms-lg-3">
          <!--begin::Menu- wrapper-->
          <div id="sendMarkRequest" onclick="return sendMarkRequest()" class="btn btn-icon btn-active-light-primary w-30px h-30px w-md-40px h-md-40px position-relative pulse pulse-success" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
          ...
          <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
            ...
            <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url({{ asset('assets/media/misc/menu-header-bg.jpg')}})">
              <!--begin::Title-->
              <h3 class="text-white fw-semibold px-9 mt-10 mb-6">السجلات
                <span class="badge badge-circle badge-danger ms-2">{{ $notifications->count() }}</span></h3>
              <!--end::Title-->
              <!--begin::Tabs-->
              <ul class="nav nav-line-tabs nav-line-tabs-2x nav-stretch fw-semibold px-9">
                <li class="nav-item">
                  <a class="nav-link text-white opacity-75 opacity-state-100 pb-4 active" data-bs-toggle="tab" href="#kt_topbar_notifications_1">المشاريع الجديدة <span class="badge badge-danger badge-circle badge-sm ms-2"> {{ $project_notifications->count() }}</span></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link text-white opacity-75 opacity-state-100 pb-4" data-bs-toggle="tab" href="#kt_topbar_notifications_2">العمل الميداني <span class="badge badge-danger badge-circle badge-sm ms-2"> {{ $fieldwork_notifications->count() }}</span></a>
                </li>
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane fade show active" id="kt_topbar_notifications_1" role="tabpanel">
                ...
                <div class="scroll-y mh-325px my-5 px-8">
                  ...
                  @forelse($project_notifications as $notification)
              ...
              <div class="tab-pane fade" id="kt_topbar_notifications_2" role="tabpanel">
                ...
                <div class="scroll-y mh-325px my-5 px-8">
                  ...
                  @forelse($fieldwork_notifications as $notification)
                  <div class="d-flex flex-stack py-4">
                    <!--begin::Section-->
                    <div class="d-flex align-items-center">
                      <!--begin::Symbol-->
                  ...
                  @empty
                  لا توجد سجلات جديدة للعمل الميداني
                  @endforelse
          ...
          <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-muted menu-active-bg menu-state-color fw-semibold py-4 fs-base w-150px" data-kt-menu="true" data-kt-element="theme-mode-menu">
            ...
            <div class="menu-item px-3 my-0">
              <a href="#" class="menu-link px-3 py-2 active" data-kt-element="mode" data-kt-value="light">
                ...
                <span class="menu-title">{{ __('site.light') }}</span>
              </a>
            </div>
            <!--end::Menu item-->
            <!--begin::Menu item-->
            <div class="menu-item px-3 my-0">
              <a href="#" class="menu-link px-3 py-2" data-kt-element="mode" data-kt-value="dark">
                ...
                <span class="menu-title">{{ __('site.dark') }}</span>
              </a>
            </div>
            <!--end::Menu item-->
            <!--begin::Menu item-->
            <div class="menu-item px-3 my-0">
              <a href="#" class="menu-link px-3 py-2" data-kt-element="mode" data-kt-value="system">
                ...
                <span class="menu-title">{{ __('site.system') }}</span>
              </a>
            </div>
            <!--end::Menu item-->
          </div>
        ...
        <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
          ...
          <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-start">
            @if(Auth::user()->avatar)
            <img alt="Logo" src="{{ asset('storage/' . Auth::user()->avatar) }}" onerror="this.onerror=null; this.src='{{ asset('assets/media/avatars/blank.png')}} '"/>
            @endif
          </div>
          ...
          <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
              ...
              <div class="menu-content d-flex align-items-center px-3">
                ...
                <div class="d-flex flex-column">
                  <div class="fw-bold d-flex align-items-center fs-5">{{ Auth::user()->name ?? '-' }}
                    <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">{{ auth()->user()->getRoletitle() }}</span>
                  </div>
                  <a href="{{ route('profile')}}" class="fw-semibold text-muted text-hover-primary fs-7">{{ Auth::user()->email ?? '-' }}</a>
                </div>
                <!--end::Username-->
              </div>
            </div>
            ...
            <!--begin::Menu item-->
            <div class="menu-item px-5">
              <a href="{{ url('/' . Auth::user()->roles[0]->name . '/projects') }}" class="menu-link px-5">
                <span class="menu-text">المشاريع</span>
                <span class="menu-badge">
                  <span class="badge badge-light-danger badge-circle fw-bold fs-7">{{ $projectsCount }}</span>
                </span>
              </a>
            </div>
            ...
            <div class="menu-item px-5">
              <a href="{{ route('logout') }}" onclick="event.preventDefault();
                            document.getElementById('logout-form').submit();" class="menu-link px-5">{{ __('site.logout')}}</a>
