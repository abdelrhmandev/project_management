                        ...
                        <div class="col-xl-12">
                            <div class="card card-xl-stretch mb-xl-8">
                                ...
                                <div class="card-body py-3">
                                    <form class="form" id="FormId" data-route-url="{{ url('auditor/approve-team-members')}}" novalidate="novalidate" method="post">
                                        @csrf
                                        <input type="hidden" name="project_id" id="project_id" value="{{ $row->id }}" />
                                        <input type="hidden" id="redirectUrl" data-redirect-url="{{ url('auditor/projects') }}" />
                                                ...
                                                <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="0">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="ms-5">
                                                            ...
                                                            <div class="fw-semibold text-muted">{{$attracting_teams->where('id', $selected_researcher->team_user_id)->first()->email ?? ''}}</div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="modal-footer mt-8 mb-3">
                                            <button type="button" class="btn btn-light me-3" id="kt_cancel_researcher_list">{{ __('site.cancel')}}</button>
