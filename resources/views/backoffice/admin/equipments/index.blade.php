...
<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
   <h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">{{ __('equipment.all') }}
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                <div class="d-flex justify-content-end" data-kt-table-toolbar="base">
                    <a class="btn btn-offical" href="{{ route('admin.equipments.create') }}">{{ __($trans_file.'.create')}}</a>
                </div>
                <div class="d-flex justify-content-end align-items-center d-none" data-kt-table-toolbar="selected">
                    ...
                    <button type="button" class="btn btn-danger" id="destroyMultipleroute" data-destroyMultiple-route="{{ route('admin.equipments.destroyMultipleEquipment') }}" data-kt-table-select="delete_selected">{{ __('customer.delete-selected') }}</button>
                </div>
            </div>
        </div>
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_datatable">
                <thead>
                    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                        ...
                        <th class="min-w-125px">{{ __('equipment.title')}}</th>
...
<script>
    ...
    KTUtil.onDOMContentLoaded(function() {
        loadDatatable('{{ route('admin.equipments.index') }}', dynamicColumns);
    });
</script>
@stop
