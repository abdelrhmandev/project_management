    ...
    <div id="kt_content_container" class="container-xxl">
        <div class="card mb-5 mb-xl-10">
            ...
            <div id="kt_account_settings_profile_details" class="collapse show">
                <form class="form" action="{{ route('admin.users.store') }}" enctype="multipart/form-data" novalidate="novalidate" id="kt_account_profile_details_form" method="post">
                    @csrf
                    <div class="card-body border-top p-9">
                        <div class="row mb-6">
                            <label class="col-lg-4 col-form-label required fw-semibold fs-6">{{ __('site.name') }}</label>
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="name" value="{{ old('name') }}" class="form-control form-control-lg form-control-solid" placeholder="{{ __('site.name') }}" />
                                @error('name')
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <select class="form-select form-select-solid" name="roles" data-control="select2" data-hide-search="true" data-placeholder="{{ __('role.title') }}">
                                    <option></option>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="email" value="{{ old('email') }}" class="form-control form-control-lg form-control-solid" placeholder="{{ __('site.email') }}" />
                                @error('email')
                                <div class="fv-plugins-message-container invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="username" value="{{ old('username') }}" class="form-control form-control-lg form-control-solid" placeholder="{{ __('site.username') }}" />
                                @error('username')
                                <div class="fv-plugins-message-container invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                ...
                                <label class="form-check form-switch form-check-custom form-check-solid">
                                    <input class="form-check-input" type="checkbox" value="1" name="active_status" id="active_status" />
