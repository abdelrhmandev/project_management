...
<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
   <h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">خطط التنفيذ المرفوضه {{ $counter }}
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_datatable">
                <thead>
                    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                        ...
                        <th class="min-w-125px">ملف الرفض</th>
                        <th class="min-w-125px">تاريخ رفع ملف الرفض</th>
                        <th class="min-w-125px">رفع ملف الخطه التنفيذيه</th>
                    </tr>
                </thead>
...
<script>
    var dynamicColumns = [{
            ...
            data: 'rejection_file_created_at',
            name: 'rejection_file_created_at'
        },{
            data: 'actions',
            name: 'actions'
        }  
    ...
    KTUtil.onDOMContentLoaded(function() {
        loadDatatable('{{ route('RejectedProjectsPlanning') }}', dynamicColumns);
    });
</script>
@stop
