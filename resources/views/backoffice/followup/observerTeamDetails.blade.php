                    ...
                    <div class="card mb-xl-8 mb-5">
                        ...
                        <div class="card-body pt-15">
                            ...
                            <div class="d-flex flex-stack fs-4 py-3">
                                ...
                                <!--begin::Badge-->
                                <div class="badge badge-light-info d-inline">{{ $project_fieldwork_team->type[0]->trans }}
                                </div>
                                <!--begin::Badge-->
                            </div>
                            <!--end::Details toggle-->
                                ...
                                <div class="col">
                                    ...
                                    <div class="card card-xl-stretch mb-xl-8">
                                        ...
                                        <div class="card-body p-0">
                                            <!--begin::Header-->
                                            <div class="card-rounded h-275px w-100 bg-primary px-9 pt-7">
                                                <!--begin::Heading-->
                                                <div class="d-flex flex-stack">
                                                    <h3 class="fw-bold fs-3 m-0 text-white">المشرفين</h3>
                                                    <div class="ms-1">
                                                        <!--begin::Menu-->
                                                        <button type="button" class="btn btn-sm btn-icon btn-color-white btn-active-white btn-active-color-primary me-n3 border-0" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                                                ...
                                                <div class="d-flex flex-column pt-8 text-center text-white">
                                                    ...
                                                    <span class="fw-bold fs-2x pt-1">{{ $project_fieldwork_team->supervisor_qty }}</span>
                                                </div>
                                                <!--end::Balance-->
                                            </div>
                                            <!--end::Header-->
                                            ...
                                            <div class="bg-body card-rounded position-relative z-index-1 mx-9 mb-9 px-6 py-9 shadow-sm" style="margin-top: -100px">
                                                    ...
                                                    <div class="d-flex align-items-center w-100 flex-wrap">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <div class="fw-bold fs-5 pe-1 text-gray-800">
                                                                {{ count($team_details->where('type_id', 4)->where('approved', '1')) }}
                                                            </div>
                                                        </div>
                                                        <!--end::Label-->
                                                    </div>
                                                ...
                                                <div class="d-flex align-items-center mb-6">
                                                    ...
                                                    <div class="d-flex align-items-center w-100 flex-wrap">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <div class="fw-bold fs-5 pe-1 text-gray-800">
                                                                {{ count($team_details->where('type_id', 4)->where('approved', '0')) }}
                                                            </div>
                                                        </div>
                                                        <!--end::Label-->
                                                    </div>
                                    ...
                                    <div class="card card-xl-stretch mb-xl-8">
                                        ...
                                        <div class="card-body p-0">
                                            ...
                                            <div class="card-rounded h-275px w-100 bg-danger px-9 pt-7">
                                                <!--begin::Heading-->
                                                <div class="d-flex flex-stack">
                                                    <h3 class="fw-bold fs-3 m-0 text-white">الباحثين</h3>
                                                    <div class="ms-1">
                                                        <!--begin::Menu-->
                                                ...
                                                <div class="d-flex flex-column pt-8 text-center text-white">
                                                    <span class="fw-semibold fs-7">العدد الإجمالي المطلوب</span>
                                                    <span class="fw-bold fs-2x pt-1">{{ $project_fieldwork_team->researcher_qty }}</span>
                                                </div>
                                                <!--end::Balance-->
                                            </div>
                                            <!--end::Header-->
                                            ...
                                            <div class="bg-body card-rounded position-relative z-index-1 mx-9 mb-9 px-6 py-9 shadow-sm" style="margin-top: -100px">
                                                ...
                                                <div class="d-flex align-items-center mb-6">
                                                    ...
                                                    <div class="d-flex align-items-center w-100 flex-wrap">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <div class="fw-bold fs-5 pe-1 text-gray-800">
                                                                {{ count($team_details->where('type_id', 5)->where('approved', '1')) }}
                                                            </div>
                                                        </div>
                                                        <!--end::Label-->
                                                    </div>
                                                ...
                                                <div class="d-flex align-items-center mb-6">
                                                    ...
                                                    <div class="d-flex align-items-center w-100 flex-wrap">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <div class="fw-bold fs-5 pe-1 text-gray-800">
                                                                {{ count($team_details->where('type_id', 5)->where('approved', '0')) }}
                                                            </div>
                                                        </div>
                                                        <!--end::Label-->
                                                    </div>
                                                ...
                                                <div class="d-flex align-items-center mb-6">
                                                    ...
                                                    <div class="d-flex align-items-center w-100 flex-wrap">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <div class="fw-bold fs-5 pe-1 text-gray-800">
                                                                {{ $project_fieldwork_team->researcher_qty - count($team_details->where('type_id', 5)) }}
                                                            </div>
                                                        </div>
                                                        <!--end::Label-->
                                                    </div>
                                ...
                                <div class="card-body pt-0 pb-5">
                                    ...
                                    <table class="table-row-dashed gy-5 table align-middle" id="kt_table_customers_payment">
                                        ...
                                        <tbody class="fs-6 fw-semibold text-gray-600">
                                            @foreach ($team_details as $project_observer_team)
                                                <tr>
                                                    <td>
                                                        <label class="form-check form-check-custom form-check-solid me-5">
                                                            @if ($project_observer_team->created_kashef == '1')
                                                                @if (Auth::user()->hasRole('equipment'))
                                                                    <input class="form-check-input me-2" type="checkbox" name="created_kashef" checked="checked" onchange="return CreatedKashef(this, 'remove')" value="{{ $project_observer_team->id }}" />
                                                                @endif
                                                                <span class="badge badge-light-success me-4">مضاف</span>
                                                            @elseif($project_observer_team->created_kashef == '0')
                                                                @if (Auth::user()->hasRole('equipment'))
                                                                    <input class="form-check-input me-2" type="checkbox" name="created_kashef" onchange="return CreatedKashef(this, 'create')" value="{{ $project_observer_team->id }}" />
                                                                @endif
                                                    ...
                                                    <td>
                                                        <a href="#" class="text-hover-primary mb-1 text-gray-600">{{ $project_observer_team->name }}</a>
                                                    </td>
                                                    <td>{{ $project_observer_team->type[0]->trans }}</td>
                                                    <td>{{ $project_observer_team->superior[0]->name ?? $project_observer_team->teamSuperior[0]->name }}</td>
                                                    <td>{{ $project_observer_team->mobile }}</td>
                                                    <td>{{ $project_observer_team->email }}</td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
