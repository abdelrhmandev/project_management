 <div class="messenger">
    ...
    <div class="messenger-listView">
        ...
        <div class="m-header">
            ...
            {{-- Search input --}}
            <input type="text" value="{{ app('request')->input('Ref') ?? '' }}" class="messenger-search" placeholder="{{ __('site.search') }} .." />
            {{-- Tabs --}}
        ...
        <div class="m-body contacts-container">
            ...
            <div class="@if ($type == 'group') show @endif messenger-tab groups-tab app-scroll" data-view="groups">
                ...
                <p style="text-align: center;color:grey;margin-top:30px">
                    <a target="_blank" style="color:{{ $messengerColor }};" href="https://chatify.munafio.com/notes#groups-feature">Click
            ...
            <div class="messenger-tab search-tab app-scroll" data-view="search">
                ...
                <div class="search-records">
                    <p class="message-hint center-el">
                        <span>{{ __('site.type_to_search') }}..</span>
                    </p>
                </div>
            </div>
        </div>
