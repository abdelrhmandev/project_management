        ...
        <div class="d-flex flex-column flex-xl-row">
            ...
            <div class="flex-lg-row-fluid ms-lg-15">
                <div class="tab-content" id="myTabContent">
                    <form class="form" action="{{ url('it/hand-offer-task') }}" enctype="multipart/form-data" novalidate="novalidate" method="post">
                        @csrf
                            ...
                            <div class="card mb-xl-9 mb-6 pt-4">
                                ...
                                <div class="card-header border-0">
                                    ...
                                    <div class="card-title">
                                        <h2 class="fw-bold mb-0">حسابات برنامج كاشف</h2>
                                    </div>
                                    <!--end::Card title-->
                                </div>
                                <!--end::Card header-->
                                            ...
                                            <div class="d-flex align-items-center collapsible rotate" data-bs-toggle="collapse" href="#kt_customer_view_payment_method_1" role="button" aria-expanded="false" aria-controls="kt_customer_view_payment_method_1">
                                                ...
                                                <div class="me-3">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        @if ($kashef_accounts == '' || $kashef_accounts->admin_email == '')
                                                ...
                                                <div class="flex-equal me-5">
                                                    <table class="table-flush fw-semibold gy-1 table">
                                                        <tr>
                                                            ...
                                                            <td class="text-gray-800">{{ $kashef_accounts->admin_email ?? '' }}</td>
                                                        </tr>
                                                    </table>
                                                </div>
                                                <!--end::Col-->
                                                ...
                                                <div class="flex-equal">
                                                    <table class="table-flush fw-semibold gy-1 table">
                                                        <tr>
                                                            ...
                                                            <td class="text-gray-800">
                                                                <a href="#" class="text-hover-primary text-gray-900">{{ $kashef_accounts->admin_password ?? '' }}</a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
                                    ...
                                    <div class="py-0" data-kt-customer-payment-method="row">
                                        ...
                                        <div class="d-flex flex-stack flex-wrap py-3">
                                            ...
                                            <div class="d-flex align-items-center collapsible collapsed rotate" data-bs-toggle="collapse" href="#kt_customer_view_payment_method_2" role="button" aria-expanded="false" aria-controls="kt_customer_view_payment_method_2">
                                                ...
                                                <div class="me-3">
                                                    <div class="d-flex align-items-center">
                                                        <div class="fw-bold text-gray-800">حساب إستعراض التقارير</div>
                                                        @if ($kashef_accounts == '' || $kashef_accounts->report_email == '')
                                                            <div class="badge badge-light-danger ms-5">لم يتم إنشائه بعد</div>
                                                            <td class="text-gray-800">
                                                                <span class="svg-icon svg-icon-2 svg-icon-danger">
                                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="d-flex ms-9 my-3">
                                                <!--begin::Edit-->
                                                <a href="#" id="kt_modal_new_card_report" class="btn btn-icon btn-active-light-primary w-30px h-30px me-3" data-bs-toggle="modal" data-bs-target="#kt_modal_new_card">
                                                    <span data-bs-toggle="tooltip" data-bs-trigger="hover" title="Edit">
                                                        <!--begin::Svg Icon | path: icons/duotune/art/art005.svg-->
                                                        <span class="svg-icon svg-icon-3">
                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <!--end::Header-->
                                        <!--begin::Body-->
                                        <div id="kt_customer_view_payment_method_2" class="fs-6 ps-10 collapse" data-bs-parent="#kt_customer_view_payment_method">
                                            <!--begin::Details-->
                                            <div class="d-flex flex-wrap py-5">
                                                <!--begin::Col-->
                                                <div class="flex-equal me-5">
                                                    <table class="table-flush fw-semibold gy-1 table">
                                                        <tr>
                                                            <td class="text-muted min-w-125px w-125px">البريد الإلكتروني</td>
                                                            <td class="text-gray-800">{{ $kashef_accounts->report_email ?? '' }}</td>
                                                        </tr>
                                                    </table>
                                                </div>
                                                <!--end::Col-->
                                                ...
                                                <div class="flex-equal">
                                                    <table class="table-flush fw-semibold gy-1 table">
                                                        <tr>
                                                            <td class="text-muted min-w-125px w-125px">كلمةالمرور</td>
                                                            <td class="text-gray-800">
                                                                <a href="#" class="text-hover-primary text-gray-900">{{ $kashef_accounts->report_password ?? '' }}</a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
                                    ...
                                    <div class="py-0" data-kt-customer-payment-method="row">
                                        ...
                                        <div class="d-flex flex-stack flex-wrap py-3">
                                            ...
                                            <div class="d-flex align-items-center collapsible collapsed rotate" data-bs-toggle="collapse" href="#kt_customer_view_payment_method_3" role="button" aria-expanded="false" aria-controls="kt_customer_view_payment_method_3">
                                                ...
                                                <div class="me-3">
                                                    <div class="d-flex align-items-center">
                                                        <div class="fw-bold text-gray-800">حساب الدراسات</div>
                                                        @if ($kashef_accounts == '' || $kashef_accounts->studies_email == '')
                                                            <div class="badge badge-light-danger ms-5">لم يتم إنشائه بعد</div>
                                                            <td class="text-gray-800">
                                                                <span class="svg-icon svg-icon-2 svg-icon-danger">
                                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="d-flex ms-9 my-3">
                                                <!--begin::Edit-->
                                                <a href="#" id="kt_modal_new_card_studies" class="btn btn-icon btn-active-light-primary w-30px h-30px me-3" data-bs-toggle="modal" data-bs-target="#kt_modal_new_card">
                                                    <span data-bs-toggle="tooltip" data-bs-trigger="hover" title="Edit">
                                                        <!--begin::Svg Icon | path: icons/duotune/art/art005.svg-->
                                                        <span class="svg-icon svg-icon-3">
                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <!--end::Header-->
                                        <!--begin::Body-->
                                        <div id="kt_customer_view_payment_method_3" class="fs-6 ps-10 collapse" data-bs-parent="#kt_customer_view_payment_method">
                                            <!--begin::Details-->
                                            <div class="d-flex flex-wrap py-5">
                                                <!--begin::Col-->
                                                <div class="flex-equal me-5">
                                                    <table class="table-flush fw-semibold gy-1 table">
                                                        <tr>
                                                            <td class="text-muted min-w-125px w-125px">البريد الإلكتروني</td>
                                                            <td class="text-gray-800">{{ $kashef_accounts->studies_email ?? '' }}</td>
                                                        </tr>
                                                    </table>
                                                </div>
                                                <!--end::Col-->
                                                ...
                                                <div class="flex-equal">
                                                    <table class="table-flush fw-semibold gy-1 table">
                                                        <tr>
                                                            <td class="text-muted min-w-125px w-125px">كلمة المرور</td>
                                                            <td class="text-gray-800">
                                                                <a href="#" class="text-hover-primary text-gray-900">{{ $kashef_accounts->studies_password ?? '' }}</a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
                                    ...
                                    <div class="py-0" data-kt-customer-payment-method="row">
                                        ...
                                        <div class="d-flex flex-stack flex-wrap py-3">
                                            ...
                                            <div class="d-flex align-items-center collapsible collapsed rotate" data-bs-toggle="collapse" href="#kt_customer_view_payment_method_4" role="button" aria-expanded="false" aria-controls="kt_customer_view_payment_method_4">
                                                ...
                                                <div class="me-3">
                                                    <div class="d-flex align-items-center">
                                                        <div class="fw-bold text-gray-800">رابط برنامج كاشف</div>
                                                        @if ($kashef_accounts == '' || $kashef_accounts->url == '')
                                                            <div class="badge badge-light-danger ms-5">لم يتم إنشائه بعد</div>
                                                            <td class="text-gray-800">
                                                                <span class="svg-icon svg-icon-2 svg-icon-danger">
                                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <div class="flex-equal me-5">
                                                    <table class="table-flush fw-semibold gy-1 table">
                                                        <tr>
                                                            ...
                                                            <td class="text-gray-800">{{ $kashef_accounts->url ?? '' }}</td>
                                                        </tr>
                                                    </table>
                                                </div>
                                                <!--end::Col-->
            ...
            <div class="modal-dialog modal-dialog-centered mw-650px">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body scroll-y mx-xl-15 mx-5 my-7">
                        <!--begin::Form-->
                        <form id="kt_modal_new_card_form" class="form" action="{{ url('it/create-kashef-account') }}" method="post">
                            @csrf
                            <input type="hidden" name="project_id" id="project_id" value="{{ $row->id }}" />
                            <input type="hidden" name="type_id" id="type_id" />
                            <input type="hidden" name="admin_email" id="admin_email" value="{{ $kashef_accounts->admin_email ?? '' }}" />
                            <input type="hidden" name="admin_password" id="admin_password" value="{{ $kashef_accounts->admin_password ?? '' }}" />
                            <input type="hidden" name="report_email" id="report_email" value="{{ $kashef_accounts->report_email ?? '' }}" />
                            <input type="hidden" name="report_password" id="report_password" value="{{ $kashef_accounts->report_password ?? '' }}" />
                            <input type="hidden" name="studies_email" id="studies_email" value="{{ $kashef_accounts->studies_email ?? '' }}" />
                            <input type="hidden" name="studies_password" id="studies_password" value="{{ $kashef_accounts->studies_password ?? '' }}" />
                    ...
                    <div class="modal-body scroll-y mx-xl-15 mx-5 my-7">
                        ...
                        <form id="kt_modal_new_card_form" class="form" action="{{ url('it/create-kashef-account') }}" method="post">
                            ...
                            <div class="d-flex flex-column fv-row mb-7">
                                <!--begin::Label-->
                                <label class="d-flex align-items-center fs-6 fw-semibold form-label mb-2">
                                    <span class="required">الرابط الإلكتروني لبرنامج كاشف</span>
                                    <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Specify a card holder's name"></i>
                                </label>
                                <!--end::Label-->
                                <input type="text" class="form-control form-control-solid" placeholder="الرابط الإلكتروني" name="url" id="url" value="{{ $kashef_accounts->url ?? '' }}" />
                            </div>
                            <!--end::Input group-->
                            <!--begin::Actions-->
                            <div class="pt-15 text-center">
...
@section('scripts')
    <script src="{{ asset('assets/js/custom/backoffice/it.js') }}"></script>
@stop
