        ...
        <div class="content d-flex flex-row">
                ...
                <div class="card card-flush" id="kt_contacts_list">
                    ...
                    <div class="card-header pt-7" id="kt_contacts_list_header">
                        ...
                        <form class="d-flex align-items-center position-relative w-100 m-0" autocomplete="off">
                            ...
                            <input type="text" id="observerFilterSuperVisor" class="form-control form-control-solid ps-13" name="search" value="" placeholder="إبحث عن المشرفين" />
                            <!--end::Input-->
                        </form>
                        <!--end::Form-->
                    </div>
                    <!--end::Card header-->
                    <!--begin::Card body-->
                    <div class="card-body pt-5" id="supervisorlist">
                        <!--begin::List-->
                        <div class="scroll-y me-n5 pe-5 h-300px h-xl-auto" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_header, #kt_toolbar, #kt_footer, #kt_contacts_list_header" data-kt-scroll-wrappers="#kt_content, #kt_contacts_list_body" data-kt-scroll-stretch="#kt_contacts_list, #kt_contacts_main" data-kt-scroll-offset="5px">
                            ...
                            <div class="mb-2">
                                ...
                                <label class="btn btn-outline btn-outline-dashed btn-active-light-primary d-flex align-items-center form-check-label" for="kt_create_account_form_account_type_personal . {{$observer_team->team_user_id}}">
                                    <input type="radio" onClick="reloadResearcher({{ $observer_team->team_user_id }}, {{ $project_id }}, 'none')" class="form-check-input" name="team_user_id" value="{{$observer_team->superior_id}}" id="kt_create_account_form_account_type_personal . {{$observer_team->team_user_id}}" />
                                    <!--begin::Details-->
                                    <div class="ms-4">
            ...
            <div class="col-lg-6 col-xl-6 mb-8 mx-8">
                ...
                <div class="card card-flush" id="kt_contacts_list">
                    ...
                    <div class="card-header pt-7" id="kt_contacts_list_header">
                        <!--begin::Form-->
                        <div id="reasercher-list" class="text-gray-900" style="font-weight:bold;font-size:20px;width:100%;">
                        قائمة الباحثين (<span id="count">0</span>)
                         <span style="display:inline-block;font-size:13px;color:#C7C7C7;float:left;">تم تحديد <span id="nums">0</span> باحثين</span>
                        </div>
                        <form class="d-flex align-items-center position-relative mt-2" autocomplete="off">
                            <!--begin::Icon-->
                            <!--begin::Svg Icon | path: icons/duotune/general/gen021.svg-->
                            <span class="svg-icon svg-icon-3 svg-icon-gray-500 position-absolute top-50 ms-5 translate-middle-y">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="card-body pt-8" id="kt_contacts_list_body">
                        ...
                        <input type="hidden" name="is_correction" id="is_correction" value="false" />

                        <!--begin::List-->
                        <div class="scroll-y me-n5 pe-5 h-600px h-xl-auto" id="researcherlist" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_header, #kt_toolbar, #kt_footer, #kt_contacts_list_header" data-kt-scroll-wrappers="#kt_content, #kt_contacts_list_body" data-kt-scroll-stretch="#kt_contacts_list, #kt_contacts_main" data-kt-scroll-offset="5px">
                            @include('partials.backoffice.observer.researcherlist')
                        </div>
                        <!--end::List-->
                    </div>
                    <!--end::Card body-->
                    <div class="text-center mb-3">
                        <a href="#" class="btn btn-primary me-3" id="kt_save_researcher_list" data-bs-toggle="tooltip" data-bs-dismiss="click" data-bs-trigger="hover">تأكيد الاختيار</a>
                        <a href="#" class="btn btn-secondary" id="kt_cancel_researcher_list" data-bs-toggle="tooltip" data-bs-dismiss="click" data-bs-trigger="hover">إلغاء</a>
                    </div>
                </div>
                <!--end::Contacts-->
            </div>
            @include('partials.backoffice.observer.import-researcers')
        </div>
    </div>
    <!--end::Container-->
</div>
...
<script src="{{ asset('assets/js/custom/backoffice/import-researchers.js') }}"></script>
@stop
