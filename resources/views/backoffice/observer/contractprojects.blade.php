...
<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
   <h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">عقود {{ __('project.all') }}
...
<div id="kt_content_container" class="container-xxl">
   ...
   <div class="row g-6 g-xl-9" id="projectList">
      ...
      <div class="col-md-6 col-xl-4 projectData" data-name="{{ $row->title }}">
         <!--begin:: Card header-->
         <a href="{{ url('observer/contract-projects/details/'.$row->id) }}" class="card border-hover-primary">
