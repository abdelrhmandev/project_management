...
<div id="kt_content_container" class="container-xxl">
   ...
   <div class="row g-6 g-xl-9" id="projectList">
      ...
      <div class="col-md-6 col-xl-4 projectData" data-name="{{ $row->title }}">
         <!--begin:: Card header-->
         <a href="{{ $row->status_id === 8 || $taskType === 'approval' ? url('observer/get-team-members/'.$row->id.'/'.$taskType ?? ' ') : ($taskType == 'none'? route($resource.'.edit', $row->id) : ($taskType == 'correction'? url('observer/correction/'.$row->id) : url('observer/tour/'.$row->id)) )}}" class="card border-hover-primary">
