...
<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
    <h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">الصور التي تم معالجتها
...
<div class="modal fade" id="kt_modal_view_processed_details" tabindex="-1" aria-hidden="true">
                        ...
                        <div class="current" data-kt-stepper-element="content">
                            <div class="w-100">
                                <div class="mb-10 fv-row">
                                    ...
                                    <input type="text" class="form-control form-control-lg form-control-solid" name="name" id="name" placeholder="" value="" disabled />
                                </div>
...
<script>
    ...
    KTUtil.onDOMContentLoaded(function() {
        loadDatatable('{{ route('processed') }}', dynamicColumns);
    });
    ...
    function attractingTeamDetails(id) {
        $.ajax({
            ...
            success: function(data) {
                ...
                var avatar = dirstorage + '/' + data.avatar;
                $("#avatar_preview").html('<img src="' + avatar + '" class="w-25">');
            }
        });

        $("#kt_modal_view_processed_details").modal('show');
    }
</script>
@stop