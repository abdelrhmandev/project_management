...
<div class="mb-2">
    <label id="mylist" class="btn btn-outline btn-outline-dashed btn-active-light-primary d-flex align-items-center mr-12" for="kt_select_researcher . {{ $selected_researcher->team_user_id }}">
        <input type="checkbox" class="form-check-input researcherBox" name="selected_researcher_id[]" value="{{ $selected_researcher->team_user_id }}" id="kt_select_researcher . {{ $selected_researcher->team_user_id }}" checked />
        <div class="ms-4">
...
<div class="mb-2" id="newResearcherlist">
    <label id="mylist" class="btn btn-outline btn-outline-dashed btn-active-light-primary d-flex align-items-center mr-12" for="kt_select_researcher . {{ $selected_attracting_team->id }}">
        <input type="checkbox" class="form-check-input researcherBox" name="researcher_id[]" value="{{ $selected_attracting_team->id }}" id="kt_select_researcher . {{ $selected_attracting_team->id }}" />
        <div class="ms-4">
            ...
            <div class="fw-semibold fs-7 text-muted text-start">
                {{ $selected_attracting_team->performance_percentage }}%
