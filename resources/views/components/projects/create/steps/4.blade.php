<div class="w-100">
	...
	<div class="fv-row mb-8">
		...
		<div class="d-flex flex-stack">
			...
			<label class="form-check form-switch form-check-custom form-check-solid">
				<input class="form-check-input" type="checkbox" value="1" name="opening" checked="checked" onchange="manageOpening(this)"/>
	...
	<div id="opening_div">
		<div class="fv-row mb-8">
			...
			<div class="d-flex flex-stack">
				...
				<!--begin::Switch-->
				<label class="form-check form-switch form-check-custom form-check-solid">
					<input class="form-check-input" type="checkbox" value="1" name="opening_reserve_hall" checked="checked"/>
					<span class="form-check-label fw-semibold text-muted">{{ __('site.yes')}}</span>
				</label>
				<!--end::Switch-->
			</div>
			...
			<div class="row g-9" data-kt-buttons="true" data-kt-buttons-target="[data-kt-button='true']">
				...
				<div class="col-md-6 col-lg-12 col-xxl-6">
					...
					<label class="btn btn-outline btn-outline-dashed btn-active-light-primary active d-flex text-start p-6" data-kt-button="true">
						...
						<span class="form-check form-check-custom form-check-solid form-check-sm align-items-start mt-1">
							<input class="form-check-input" type="radio" name="opening_attendance_nature" value="regulars" checked="checked" />
						</span>
						<!--end::Radio-->
						<!--begin::Info-->
						<span class="ms-5">
				...
				<div class="col-md-6 col-lg-12 col-xxl-6">
					...
					<label class="btn btn-outline btn-outline-dashed btn-active-light-primary d-flex text-start p-6" data-kt-button="true">
						<!--begin::Radio-->
						<span class="form-check form-check-custom form-check-solid form-check-sm align-items-start mt-1">
							<input class="form-check-input" type="radio" name="opening_attendance_nature" value="leaders" />
						</span>
						<!--end::Radio-->
						<!--begin::Info-->
						<span class="ms-5">
		...
		<div class="fv-row mb-8">
			...
			<div class="position-relative d-flex align-items-center">
				...
				<!--end::Icon-->
				<!--begin::Datepicker-->
				<input class="form-control form-control-solid ps-12" placeholder="{{ __('project.opening_date')}}" name="opening_date" />
				<!--end::Datepicker-->
			</div>
			<!--end::Col-->
		</div>
	...
	<!--begin::Actions-->
	<div class="d-flex flex-stack">
		<button type="button" class="btn btn-lg btn-light me-3" data-kt-element="opening-previous" id="closeBack">
			<span class="svg-icon svg-icon-muted svg-icon-2hx"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<path d="M15.6343 11.4343L11.45 7.25C11.0358 6.83579 11.0358 6.16421 11.45 5.75C11.8642 5.33579 12.5358 5.33579 12.95 5.75L18.4929 11.2929C18.8834 11.6834 18.8834 12.3166 18.4929 12.7071L12.95 18.25C12.5358 18.6642 11.8642 18.6642 11.45 18.25C11.0358 17.8358 11.0358 17.1642 11.45 16.75L15.6343 12.5657C15.9467 12.2533 15.9467 11.7467 15.6343 11.4343Z" fill="currentColor"/>
				 ...
				 المخرجات</button>
		<button type="button" class="btn btn-lg btn-primary" data-kt-element="opening-next" id="close">
