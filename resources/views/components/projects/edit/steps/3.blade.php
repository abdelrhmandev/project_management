<div class="w-100">
	<div class="fv-row mb-10">
		...
		<div class="image-input image-input-empty image-input-outline image-input-placeholder_edit" data-kt-image-input="true">
	...
	<div class="fv-row mb-8">
		<label class="fs-6 fw-semibold mb-2">{{ __('project.rfp')}}</label>
		<div id="edit_rfp"></div>
	...
	<div class="fv-row mb-8">
		...
		<div id="edit_additional_questions"></div>
	...
	<div class="fv-row mb-8">
		<label class="fs-6 fw-semibold mb-2">{{ __('project.requirements_specifications')}}</label>
		<div id="edit_requirements_specifications"></div>
	...
	<div class="fv-row mb-8" id="google_mapEdit">
		<label class="fs-6 fw-semibold mb-2">{{ __('project.google_map')}}</label>
		<div id="edit_google_map"></div>
		<input type="file" accept=".kml, .kmz" class="form-control form-control-solid" placeholder="{{ __('project.google_map')}}.." name="google_map" />
	</div>
	<div class="fv-row mb-8" id="research_surveyEdit">
		<label class="fs-6 fw-semibold mb-2">{{ __('project.research_survey')}}</label>
		<div id="edit_research_survey"></div>
	...
	<div class="fv-row mb-8" id="charity_listEdit">
		<label class="fs-6 fw-semibold mb-2">{{ __('project.charity_list_file')}}</label>
		<div id="edit_charity_list"></div>
	...
	<div id="training_filesEdit">
		<div class="fv-row mb-8">
			<label class="fs-6 fw-semibold mb-2">{{ __('project.training_agenda')}}</label>
			<div id="edit_training_agenda"></div>
		...
		<div class="fv-row mb-8">
			<label class="fs-6 fw-semibold mb-2">{{ __('project.trainee_list')}}</label>
			<div id="edit_trainee_list"></div>
