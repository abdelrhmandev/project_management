    ...
    <div class="fv-row mb-8">
        ...
        <div class="d-flex flex-stack">
            ...
            <label class="form-check form-switch form-check-custom form-check-solid">
                <input class="form-check-input" type="checkbox" value="1" name="closing" id="closing_edit"
                    onchange="manageClosingEdit(this)" />
    ...
    <div id="closing_div_edit">
        <div class="fv-row mb-8">
            ...
            <div class="d-flex flex-stack">
                ...
                <!--begin::Switch-->
                <label class="form-check form-switch form-check-custom form-check-solid">
                    <input class="form-check-input" type="checkbox" value="1" name="closing_reserve_hall"
                        id="closing_reserve_hall_edit" />
                    <span class="form-check-label fw-semibold text-muted">{{ __('site.yes') }}</span>
                </label>
                <!--end::Switch-->
            </div>
        ...
        <div class="fv-row mb-8">
            ...
            <div class="row g-9" data-kt-buttons="true" data-kt-buttons-target="[data-kt-button='true']">
                ...
                <div class="col-md-6 col-lg-12 col-xxl-6">
                    <!--begin::Option-->
                    <label id="edit_closing_regulars_label"
                        class="btn btn-outline btn-outline-dashed d-flex text-start p-6" data-kt-button="true">
                        <!--begin::Radio-->
                        <span
                            class="form-check form-check-custom form-check-solid form-check-sm align-items-start mt-1">
                            <input class="form-check-input" type="radio" name="closing_attendance_nature"
                                id="closing_attendance_nature_regulars_edit" value="regulars" />
                        </span>
                        <!--end::Radio-->
                        <!--begin::Info-->
                        <span class="ms-5">
                ...
                <div class="col-md-6 col-lg-12 col-xxl-6">
                    <!--begin::Option-->
                    <label id="edit_closing_leaders_label"
                        class="btn btn-outline btn-outline-dashed d-flex text-start p-6" data-kt-button="true">
                        <!--begin::Radio-->
                        <!--begin::Radio-->
                        <span
                            class="form-check form-check-custom form-check-solid form-check-sm align-items-start mt-1">
                            <input class="form-check-input" type="radio" name="closing_attendance_nature"
                                id="closing_attendance_nature_leaders_edit" value="leaders" />
                        </span>
                        <!--end::Radio-->
                        <!--begin::Info-->
                        <span class="ms-5">
        ...
        <div class="fv-row mb-8">
            ...
            <div class="position-relative d-flex align-items-center">
                ...
                <input class="form-control form-control-solid ps-12" placeholder="{{ __('project.closing_date') }}"
                    name="closing_date" id="closing_date_edit" />
            </div>
        </div>
    </div>
    <!--begin::Actions-->
    <div class="d-flex flex-stack">
        <button type="button" class="btn btn-lg btn-light me-3" data-kt-element="closing-previous">
        ...
        <button type="button" class="btn btn-lg btn-primary" data-kt-element="closing-next">
