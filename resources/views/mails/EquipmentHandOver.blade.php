                    ...
                    <div style="background-color:#ffffff; font-family:'Cairo', sans-serif !important; padding: 45px 0 34px 0; border-radius: 24px; margin:40px auto; max-width: 600px;">
                        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" height="auto" style="border-collapse:collapse">
                            <tbody>
                                    ...
                                    <td align="center" valign="center" style="text-align:center !important; padding-bottom: 10px">
                                        ...
                                        <div style="text-align:center !important; margin:0 15px 34px 15px">
                                            ...
                                            <h2 style="text-align:center;font-size:30px;color:#014358;font-family:'Cairo', sans-serif !important">
                                                تهانينا للإنضمام إلى شركة الفارس للبحوث والدراسات
                                            </h2>
                                            <!--end:Header-->
                                            ...
                                            <div style="border:1px solid #D1D1D1;border-radius:21px;padding:20px 0px;">
                                                <div style="font-size: 14px; font-weight: bold; margin-bottom: 20px;
                                                    ...
                                                    <p style="margin-bottom:9px; color:#000000; font-size:20px;
                                                        ...
                                                        للاطلاع على بيانات الدخول الى برنامج كاشف
                                                    </p>
                                                </div>
                                                <br>
                                                ...
                                                <strong style="font-family: 'Cairo', sans-serif !important;">عنوان المشروع :</strong> {{ $mailData['project_title'] }} 
                                                </p>

                                                <p style="margin-bottom:9px; color:#014358; font-size: 22px;
                                                font-weight:500;font-family:'Cairo', sans-serif !important;
                                                text-align: center !important;direction:ltr;">
                                                    <strong style="font-family: 'Cairo', sans-serif !important;">{{ $mailData['url'] }} :</strong> رابط برنامج كاشف
                                                </p>

                                                <p style="margin-bottom:9px; color:#014358; font-size: 22px;
                                                font-weight:500;font-family:'Cairo', sans-serif !important;
                                                text-align: center !important;direction:ltr;">
                                                    <strong style="font-family: 'Cairo', sans-serif !important;">{{ $mailData['email'] }} :</strong> البريد الإلكتروني
                                                </p>

                                                <p style="margin-bottom:9px; color:#014358; font-size: 22px;
                                                    font-weight:500;font-family:'Cairo', sans-serif !important;
                                                    text-align: center !important;direction:ltr;">
                                                    <strong style="font-family: 'Cairo', sans-serif !important;">12345678 :</strong> كلمه المرور
                                                </p>
                                ...
                                <tr>
                                    <td align="center" valign="center" style="font-size: 14px; padding:0 15px; text-align:center !important;font-weight: 500; color: #000000;font-family:'Cairo', sans-serif !important;">
