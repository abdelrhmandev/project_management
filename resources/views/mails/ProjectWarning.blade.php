                                    ...
                                    <td align="center" valign="center" style="text-align:center !important; padding-bottom: 10px">
                                        ...
                                        <div style="text-align:center !important; margin:0 15px 34px 15px">
                                            ...
                                            <div style="margin-bottom: 10px">
                                                ...
                                                @if($warnData[2] == "caution" || $warnData[2] == "excaution")
                                                    <img alt="al-fares" src="https://al-fares.sa/project/public/assets/media/training/3d-stopwatch.png" />
                                                    @else
                                                    <img alt="al-fares" src="https://al-fares.sa/project/public/assets/media/training/complain.png" />
                                                    @endif
                                                </a>
                                            </div>
                                            <!--end:Logo-->
                                            ...
                                            <div style="font-size: 14px; font-weight: bold; margin-bottom: 27px; font-family:'Cairo', sans-serif !important;">
                                                <p style="margin-bottom:9px; color:#014358; font-size: 22px; font-weight:700;font-family:'Cairo', sans-serif !important;
                                                    ...
                                                    @switch($warnData[2])
                                                        @case("caution")
                                                        <span style="color:#00AC9F;">نود أن نلفت انتباهكم إلى أن مشروع {{$warnData[0]}} قد قارب</span>
                                                      على إنتهاء فترة التهيئة المحددة مسبقاً
                                                            @break
                                                        @case("warning")
                                                        <span style="color:#00AC9F;">نود أن نلفت انتباهكم إلى أن مشروع {{$warnData[0]}} قد إنتهت</span>
                                                      فترة التهيئة المحددة مسبقاً
                                                           @break
                                                        @case("excaution")
                                                      <span style="color:#00AC9F;">نود أن نلفت انتباهكم إلى أن مشروع {{$warnData[0]}} قد قارب</span>
                                                      على إنتهاء فترة التنفيذ المحددة مسبقاً
                                                           @break
                                                        @case("exwarning")
                                                      <span style="color:#00AC9F;">نود أن نلفت انتباهكم إلى أن مشروع {{$warnData[0]}} قد إنتهت</span>
                                                      فترة التنفيذ المحددة مسبقاً
                                                           @break
                                                      @default
                                            ...
                                            <!--end:Text-->
                                            <!--begin:Action-->
                                            <a href="{{ $warnData[1]}}" target="_blank" style="background-color:#00AC9F;
