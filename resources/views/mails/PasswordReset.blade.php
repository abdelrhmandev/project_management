                                        ...
                                        <div style="text-align:center !important; margin:0 15px 34px 15px">
                                            ...
                                            <div style="margin-bottom: 10px">
                                                <a href="https://al-fares.sa" rel="noopener" target="_blank">
                                                    <img alt="al-fares" src="https://al-fares.sa/project/public/assets/media/training/resetpass-6.png" />
                                                </a>
                                            </div>
                                            <!--end:Logo-->
                                            <!--begin:Text-->
                                            <div style="font-size: 14px; font-weight: bold; margin-bottom: 27px; font-family:'Cairo', sans-serif !important;">
                                            <p style="margin-bottom:20px; color:#014358; font-size: 22px; font-weight:bold;font-family:'Cairo', sans-serif !important;
                                                    text-align: right !important;">
                                                       <strong>مرحبا بك {{$PassData['userName']}},</strong>
                                                </p>
                                                <p style="margin-bottom:9px; color:#023444; font-size: 18px; font-weight:600;font-family:'Cairo', sans-serif !important;
                                                    text-align: right !important;">
                                                       شكراً لك على التواصل. إذا كنت فعلاً ترغب في إعادة تعيين كلمة المرور الخاصة بحسابكم. الرجاء إستخدام الرابط أدناه
                                                </p>
                                                <a href="{{$PassData['route']}}" style="margin-bottom:9px; color:#00AC9F; font-size: 18px;
                                                    font-weight:600;font-family:'Cairo', sans-serif !important;
                                                    text-align: right !important;text-decoration:none;">
                                                    {{$PassData['route']}}
                                                  </a>
                                                  <br>
                                                  <small style="margin-bottom:9px; color:#023444; font-size: 14px; font-weight:light;font-family:'Cairo', sans-serif !important;
                                                    text-align: right !important;">تنبيه: صلاحية الرابط تنتهي بعد ساعة</small>
                                             </div>
                                            <!--end:Text-->
                                        </div>
                                        <!--end:Email content-->
