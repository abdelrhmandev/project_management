                                        ...
                                        <div style="text-align:center !important; margin:0 15px 34px 15px">
                                            ...
                                            <div style="margin-bottom: 10px">
                                                <a href="https://al-fares.sa" rel="noopener" target="_blank">
                                                    <img alt="al-fares" src="https://al-fares.sa/project/public/assets/media/training/id-card.png" />
                                                </a>
                                            </div>
                                            <!--end:Logo-->
                                            <!--begin:Text-->
                                            <div style="font-size: 14px; font-weight: bold; margin-bottom: 27px; font-family:'Cairo', sans-serif !important;">
                                                <p style="margin-bottom:9px; color:#014358; font-size: 22px; font-weight:700;font-family:'Cairo', sans-serif !important;
                                                    ...
                                                    نشكر لكم على تأكيدكم بالإنضمام بالعمل في مشروع <span  style="color:#18C9BB;font-family:'Cairo', sans-serif !important;">{{$cardData[0]}}</span> ونود أن نعلمك أنه يمكنك طباعة البطاقة التعريفية الخاصة بكم
                                                </p>
                                            ...
                                            <a href="{{url(stristr($cardData[1],'cards'))}}" target="_blank" style="background-color:#00AC9F;
                                                border-radius:10px;display:inline-block;
                                                padding:20px 0px; color: #ffffff; font-size: 16px;
                                                font-weight:600;font-family:'Cairo', sans-serif !important;
                                                text-decoration:none !important;width:170px;text-align:center;">البطاقة</a>
                                                &nbsp;&nbsp;
                                             {{--
                                            <a href="{{url(stristr($cardData[3],'cards'))}}" target="_blank" style="background-color:#00AC9F;
                                                border-radius:10px;display:inline-block;
                                                padding:20px 0px; color: #ffffff; font-size: 16px;
                                                font-weight:600;font-family:'Cairo', sans-serif !important;
                                                text-decoration:none !important;width:170px;text-align:center;">البطاقة الخلفية</a>
                                          --}}
                                        </div>
                                        <!--end:Email content-->
                                    </td>
