                                        ...
                                        <div style="text-align:center !important; margin:0 15px 34px 15px">
                                            ...
                                            <div style="margin-bottom: 10px">
                                                <a href="https://al-fares.sa" rel="noopener" target="_blank">
                                                    <img alt="al-fares" src="https://al-fares.sa/project/public/assets/media/training/newspaper.png" />
                                                </a>
                                            </div>
                                            <!--end:Logo-->
                                            <!--begin:Text-->
                                            <div style="font-size: 14px; font-weight: 500; margin-bottom: 27px; font-family:'Cairo', sans-serif !important;">
                                                <p style="margin-bottom:9px; color:#014358;
                                                font-size: 22px; font-weight:700;font-family:'Cairo', sans-serif !important;
                                                    text-align: center !important;">
                                                    للموافقة على العقد مع شركة الفارس للبحوث والدراسات الرجاء الضغط على الرابط</p>
                                                <p style="margin-bottom:9px; color:#00AC9F; font-size: 18px;
                                                    font-weight:600;font-family:'Cairo', sans-serif !important;
                                                    text-align: center !important;">
                                                    يحتوى العقد على كل البنود
                                                </p>
                                                <p style="margin-bottom:9px; color:#FF0000; font-size: 18px;
                                                    font-weight:600;font-family:'Cairo', sans-serif !important;
                                                    text-align: center !important;">
                                                    الرابط مدته 24 ساعة من وقت إرسال الرسالة
                                                </p>
                                            </div>
                                            <!--end:Text-->
                                            <!--begin:Action-->
                                            <a href="{{ $mailData['route']}}" target="_blank" style="background-color:#00AC9F;
                                                border-radius:10px;display:inline-block;
                                                padding:20px 0px; color: #ffffff; font-size: 16px;
                                                font-weight:600;font-family:'Cairo', sans-serif !important;
                                                text-decoration:none !important;width:170px;text-align:center;">تفاصيل العقد</a>
                                            <!--begin:Action-->
                                        </div>
                                        <!--end:Email content-->
                                    </td>
